...
{
    unsigned long int i2 = ((unsigned long int)buf[0]<<56) |
                                ((unsigned long int)buf[1]<<48) |
                                ((unsigned long int)buf[2]<<40) |
                                ((unsigned long int)buf[3]<<32) |
                                ((unsigned long int)buf[4]<<24) |
    ...
    else { i = -1 -(long int)(0xffffffffffffffffu - i2); }
...
*/
unsigned long int unpacku64(unsigned char *buf)
{
    return ((unsigned long int)buf[0]<<56) |
           ((unsigned long int)buf[1]<<48) |
           ((unsigned long int)buf[2]<<40) |
           ((unsigned long int)buf[3]<<32) |
           ((unsigned long int)buf[4]<<24) |
...
//    double *g;
    ...
    char *s;
    unsigned short int len, maxstrlen=0, count;
